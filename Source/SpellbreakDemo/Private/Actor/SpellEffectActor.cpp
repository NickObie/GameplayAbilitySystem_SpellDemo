...
void ASpellEffectActor::ApplyEffectToTarget(AActor* TargetActor, TSubclassOf<UGameplayEffect> GameplayEffectClass)
{
...
void ASpellEffectActor::OnOverlap(AActor* TargetActor)
{
...
void ASpellEffectActor::OnEndOverlap(AActor* TargetActor)
{
